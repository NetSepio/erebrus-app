...
class DWiFiNodesModel {
    ...
    factory DWiFiNodesModel.fromRawJson(String str) => DWiFiNodesModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory DWiFiNodesModel.fromJson(Map<String, dynamic> json) => DWiFiNodesModel(
